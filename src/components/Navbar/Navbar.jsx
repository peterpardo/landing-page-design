    ...
    <nav>
      ...
      <div 
        ...
        <svg width="32" height="18" xmlns="http://www.w3.org/2000/svg">
          <g fill="#151515" fillRule="evenodd"><path d="M0 0h32v2H0zM0 8h32v2H0zM0 16h32v2H0z"/></g>
        </svg>
      </div>
    
      <div 
        className={isOpen ? "navContainer" : "navContainer hidden"}>
        <div className="navWrapper">
          ...
          <div 
            ...
            <svg width="26" height="26" xmlns="http://www.w3.org/2000/svg">
              <g fill="#151515" fillRule="evenodd"><path d="m2.393.98 22.628 22.628-1.414 1.414L.979 2.395z"/><path d="M.98 23.607 23.609.979l1.414 1.414L2.395 25.021z"/></g>
            </svg>
          </div>
          ...
          <ul className="navList">
            <li className="navListItem">
              <span 
                className={isOpenFeature ? "navItem active" : "navItem"}
                onClick={() => handleOpenList("feature")}>
                Features
                {isOpenFeature ? (
                  <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg">
                    <path stroke="currentColor" strokeWidth="1.5" fill="none" d="m1 5 4-4 4 4"/>
                  </svg>
                ) : (
                  <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg">
                    <path stroke="currentColor" strokeWidth="1.5" fill="none" d="m1 1 4 4 4-4"/>
                  </svg>
                )}
              </span>

              <ul className={isOpenFeature ? "subList featureList" : "hidden"}>
                <li className="subListItem">
                  ...
                  <span className="subItem">Todo List</span>
                </li>
                <li className="subListItem">
                  ...
                  <span className="subItem">Calendar</span>
                </li>
                <li className="subListItem">
                  ...
                  <span className="subItem">Reminders</span>
                </li>
                <li className="subListItem">
                  <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span className="subItem">Planning</span>
                </li>
              </ul>
            </li>
            ...
            <li className="navListItem">
              <span 
                className="navItem"
                onClick={() => handleOpenList("company")}>
                Company
                {isOpenCompany ? (
                  <svg width="10" height="6" xmlns="http://www.w3.org/2000/svg">
                    <path stroke="currentColor" strokeWidth="1.5" fill="none" d="m1 5 4-4 4 4"/>
              ...
              <ul className={isOpenCompany ? "subList companyList" : "hidden"}>
                <li className="subListItem"><span>History</span></li>
                <li className="subListItem"><span>Our Team</span></li>
                <li className="subListItem"><span>Blog</span></li>
              </ul>
            </li>

            <li className="navListItem">
              <span className="navItem">Careers</span>
            </li>
